import svgPaths from "./svg-3pc2aqitc8";
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="bg-clip-text bg-gradient-to-r col-1 flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium from-[#900] justify-center ml-0 mt-0 relative row-1 text-[12px] md:text-[14px] to-[#404040] max-w-full px-4 lg:px-0 lg:w-[441px]" style={{ WebkitTextFillColor: "transparent" }}>
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] md:gap-[24px] items-start justify-center leading-[0] relative shrink-0 text-[#404040] w-full px-4 lg:px-0" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center not-italic relative shrink-0 text-[32px] md:text-[56px] lg:text-[72px] tracking-[-1.44px] w-full max-w-full lg:h-[149px] lg:w-[619px]">
      ...
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[14px] md:text-[16px] tracking-[-0.32px] w-full max-w-full lg:w-[512px]">
...
function PrimaryButton() {
  return (
    <Link to="/contacto" className="bg-[#900] content-stretch flex items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0" data-name="Primary button">
...
function SecondaryButton() {
  return (
    <Link to="/historia" className="content-stretch flex items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0" data-name="Secondary button">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[20px] md:gap-[32px] items-start justify-center px-4 md:pl-[92px] md:pr-[40px] py-[40px] relative w-full">
          <Group />
          <Text />
          <Buttons />
        </div>
...
function DeviceFrame() {
  return (
    <div aria-hidden="true" className="content-stretch hidden lg:flex flex-col items-center justify-center overflow-clip relative rounded-bl-[16px] rounded-tl-[16px] shrink-0 w-[719px]" data-name="Device frame" role="presentation">
...
function ImageContainer() {
  return (
    <div className="content-stretch hidden lg:flex flex-col items-end justify-center pl-px py-[80px] relative shrink-0 w-[665px]" data-name="Image container">
      <DeviceFrame />
    </div>
  );
}
...
function Hero() {
  return (
    <section className="min-h-[400px] md:h-[695px] relative shrink-0 w-full" data-name="Hero 1">
      ...
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-0 lg:pl-[64px] relative size-full">
          <Container />
          <ImageContainer />
        </div>
      </div>
  ...
  return (
    <div className="absolute inset-[7.28%_0] overflow-clip" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 61 52.9737">
        <g clipPath="url(#clip0_1_327)" id="Frame">
  ...
  return (
    <div className="absolute inset-[43.13%_23.63%_34.57%_23.63%] overflow-clip" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.168 13.8245">
        <g clipPath="url(#clip0_1_322)" id="Frame">
  ...
  return (
    <article className="bg-white block rounded-[16px] size-full" data-name="Card 1">
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] w-full">
        <div className="h-[348px] relative shrink-0 w-full" data-name="360_F_632011725_wLo7D2z2Hv4Wg4Pryecac43GXLJkqv5b 1">
  ...
  return (
    <article className="bg-white block rounded-[16px] size-full" data-name="Card 2">
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <div className="h-[347px] relative shrink-0 w-full" data-name="tango-evento 1">
...
function FeatureCards() {
  return (
    <div className="bg-[#900] h-[698px] relative shrink-0 w-full" data-name="Feature cards 3">
      <ul className="gap-x-[32px] gap-y-[32px] grid grid-cols-[521px_521px] grid-rows-[repeat(2,fit-content(100%))] pb-[120px] pt-[61px] px-[177px] relative rounded-[inherit] size-full">
...
function Column3() {
  return (
    <nav className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-[130px]" data-name="Column 1">
      ...
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-full">
        <p className="leading-[1.45] whitespace-pre-wrap">Viajes</p>
      </div>
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-full">
...
function Footer() {
  return (
    <footer className="h-[409px] relative shrink-0 w-full" data-name="Footer 1">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
