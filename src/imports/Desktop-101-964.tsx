import svgPaths from "./svg-4uf8wg78ym";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[1388px]" data-name="Text">
      <div className="bg-clip-text bg-gradient-to-r flex flex-col font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[149px] justify-center leading-[0] not-italic relative shrink-0 text-[72px] text-[transparent] text-center to-[#404040] tracking-[-1.44px] w-[1387px]">
        <h2 className="block leading-[1.1]">Historia</h2>
      </div>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="col-1 content-stretch flex items-center justify-center justify-self-stretch py-[26px] relative row-2 self-start shrink-0">
      <h2 className="bg-clip-text bg-gradient-to-r block font-['Inter:Bold',sans-serif] font-bold from-[#900] leading-[1.1] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] whitespace-nowrap">1861</h2>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col h-[58px] items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-[617px]">
        <h4 className="block leading-[1.2]">Primera Contribución</h4>
      </div>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="col-1 content-stretch flex items-center justify-center justify-self-end py-[26px] relative row-2 self-start shrink-0 w-[568px]">
      <div className="bg-clip-text bg-gradient-to-r font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[133px] leading-[1.1] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] w-[305px]">
...
function Frame10() {
  return (
    <div className="col-1 content-stretch flex items-center justify-center justify-self-stretch py-[26px] relative row-2 self-start shrink-0">
      <div className="bg-clip-text bg-gradient-to-r font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[133px] leading-[1.1] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] w-[326px]">
  ...
  return (
    <div className="content-stretch flex flex-col h-[104px] items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-[688px]">
        <h4 className="block leading-[1.2]">Primera escuela de Italiano en LATAM</h4>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="content-stretch flex flex-col h-[58px] items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-[617px]">
        <h4 className="block leading-[1.2]">Compromiso Social</h4>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex items-center justify-center pl-[43px] py-[240px] relative shrink-0 w-[368px]">
      <div className="bg-clip-text bg-gradient-to-r flex flex-col font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[149px] justify-center leading-[0] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] w-[355px]">
        <h2 className="block leading-[1.1]">1870</h2>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="content-stretch flex flex-col h-[58px] items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-[617px]">
        <h4 className="block leading-[1.2]">El fortalecimiento del socorro mutuo</h4>
      </div>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="col-1 content-stretch flex items-center justify-center justify-self-stretch py-[26px] relative row-2 self-start shrink-0">
      <div className="bg-clip-text bg-gradient-to-r font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[133px] leading-[1.1] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] w-[323px]">
...
function Frame26() {
  return (
    <div className="col-1 content-stretch flex items-center justify-center justify-self-stretch py-[26px] relative row-2 self-start shrink-0">
      <div className="bg-clip-text bg-gradient-to-r font-['Inter:Bold',sans-serif] font-bold from-[#900] h-[133px] leading-[1.1] not-italic relative shrink-0 text-[128px] text-[transparent] to-[#404040] tracking-[-2.56px] w-[400px]">
...
function Text7() {
  return (
    <div className="content-stretch flex flex-col h-[104px] items-start mb-[-30px] relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-black tracking-[-0.96px] w-[688px]">
        <h4 className="block leading-[1.2]">Restauración Fachada</h4>
      </div>
    </div>
  );
}
...
function Feature() {
  return (
    <section className="h-[4881px] relative shrink-0 w-full" data-name="Feature 1">
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Company">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-black text-center tracking-[-0.48px] w-[354px]">
        <p className="leading-[1.45]">Associazione Nazionale Italiana</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Text">
      ...
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-[min-content]">
        <p className="leading-[1.45]">Descriptive line about what your company does.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <button className="block relative shrink-0 size-[24px]" data-name="Social link 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_101_971)" id="Social link 1">
...
function SocialLink1() {
  return (
    <button className="block relative shrink-0 size-[24px]" data-name="Social link 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_101_974)" id="Social link 2">
          <g id="Vector">
...
function Column1() {
  return (
    <nav className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-[311px]" data-name="Column 2">
      <Header2 />
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-[min-content]">
        <p className="leading-[1.45]">11 4381-4054</p>
      </div>
      <a className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-[311px]" href="mailto:asociacionnazionaleitaliana@gmail.com">
        <p className="[text-decoration-skip-ink:none] cursor-pointer decoration-solid leading-[1.45] underline">asociacionnazionaleitaliana@gmail.com</p>
      </a>
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.55)] tracking-[-0.08px] w-[min-content]">
        <p className="leading-[1.45]">{`Adolfo Alsina 1465 `}</p>
      </div>
    </nav>
  );
}
...
function Footer() {
  return (
    <footer className="bg-[rgba(0,168,64,0.11)] h-[409px] relative shrink-0 w-full" data-name="Footer 2">
